import {USER_SIGNIN_FAIL,USER_SIGNIN_REQUEST,USER_SIGNIN_SUCCESS,USER_SIGNOUT,
  ...
  USER_UPDATE_PROFILE_REQUEST, USER_UPDATE_PROFILE_RESET, USER_UPDATE_PROFILE_SUCCESS,USER_LIST_FAIL,
  USER_LIST_REQUEST,
  USER_LIST_SUCCESS, USER_DELETE_FAIL,
  USER_DELETE_REQUEST,
  USER_DELETE_RESET,
  USER_DELETE_SUCCESS,  USER_DETAILS_RESET,
  USER_UPDATE_FAIL,
  USER_UPDATE_REQUEST,
  USER_UPDATE_RESET,
  USER_UPDATE_SUCCESS,USER_ACTIVATE_FAIL,USER_ACTIVATE_REQUEST,USER_ACTIVATE_SUCCESS
  ...
  export const activateUserReducer = (state = {}, action) => {
    switch (action.type) {
      ...
      case USER_ACTIVATE_SUCCESS:
        return { loading: false, activateToken: action.payload };
